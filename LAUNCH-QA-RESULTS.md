...
| Agent natural-language command | typed `pay 0x2DD…41B 10` → parsed as PrivatePayments intent (71% confidence) → "Signing…" + wallet-signature overlay shown | `verification-evidence/ui-e2e/agent/` |
...
- Footer "ZERITH · PRIVATE FINANCE INFRASTRUCTURE · V1.0"
