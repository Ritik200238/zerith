...
## Summary: 28 real Sepolia txs prove the full encrypted feature set works end-to-end, including the headline multi-bidder sealed reveal, the payroll 3-recipient claim privacy assertion, and the OTC request→quote→accept round-trip
