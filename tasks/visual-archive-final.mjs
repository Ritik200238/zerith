// Final visual archive — full-page screenshots of every route with the
// burner connected, AFTER all 5 P0 fixes are in production.
//
// Captures the canonical visual state for the launch-readiness review.
...
async function main() {
  const outDir = path.join(ROOT, "verification-evidence", "visual-final");
