...
export const PRIVACY_AUDIT: Partial<Record<ContractName, PrivacyDescriptor>> = {
  ConfidentialToken: {
    ...
    stage: 3,
    encryptedFields: ["balanceOf(address)", "allowance(owner, spender)"],
    publicFields: ["name", "symbol", "decimals", "totalSupply (faucet emissions)"],
  ...
  VickreyAuction: {
    ...
    fheOps: ["asEuint128", "gt", "select (nested)", "allowGlobal", "publishDecryptResult"],
    countGetter: "getAuctionCount",
    countLabel: "auctions",
    emitsReveals: true,
  },
  ...
  Escrow: {
    ...
    fheOps: ["eq", "and", "select", "allowGlobal"],
    countGetter: null,
    countLabel: null,
    emitsReveals: false,
  },
  ...
  Referrals: {
    ...
    stage: 3,
    encryptedFields: ["earnings[referrer]", "referralCount[referrer]"],
    publicFields: ["root referrer registration"],
    fheOps: ["asEuint64", "add", "allowThis", "allow"],
    countGetter: null,
    countLabel: null,
    emitsReveals: false,
